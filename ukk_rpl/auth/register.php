...
<head>
    ...
    <title>Web Galeri Foto - Register</title>
        ...
        <div class="container d-flex flex-column align-items-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <form action="../config/aksi_register.php" method="post">
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control my-1 mb-4" placeholder="Nama Lengkap..." name="namalengkap" required>
                            <label for="" class="form-label">Email</label>
                            <input type="email" class="form-control my-1 mb-4" placeholder="Email..." name="email" required>
                ...
                <div class="w-100 d-flex justify-content-between my-2">
                    ...
                    <a href="login.php" class="text-white p-0">Sudah memiliki akun?</a>
                </div>
            </div>
        </div>
    </div>
