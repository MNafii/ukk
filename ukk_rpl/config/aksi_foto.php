...
if (isset($_POST['tambah'])) {
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO foto VALUES(0, '$judulfoto', '$deskripsifoto', '$tanggalunggah', '$namafoto', '$albumid', '$userid')");
    echo "<script>
        alert('Berhasil menambahkan data foto');
...
if (isset($_POST['edit'])) {
    ...
    echo "<script>
        alert('Berhasil memperbarui data foto');
        location.href = '../admin/foto.php';
    </script>";
}
...
if (isset($_POST['hapus'])) {
    ...
    echo "<script>
        alert('Berhasil menghapus data foto');
        location.href = '../admin/foto.php';
    </script>";
}
