...
if (isset($_POST['tambah'])) {
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO album VALUES(0, '$namaalbum', '$deskripsi', '$tanggal', '$userid')");
    echo "<script>
        alert('Berhasil menambahkan data album');
...
if (isset($_POST['edit'])) {
    ...
    echo "<script>
        alert('Berhasil memperbarui data album');
        location.href = '../admin/album.php';
    </script>";
}
...
if (isset($_POST['hapus'])) {
    ...
    echo "<script>
        alert('Berhasil menghapus data album');
        location.href = '../admin/album.php';
    </script>";
}